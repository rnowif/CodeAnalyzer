...
using CodeAnalyzer.Tests.Analysis.Coupling.TestClasses;
using FluentAssertions;
using NUnit.Framework;

namespace CodeAnalyzer.Tests.Analysis.Coupling
{
    [TestFixture]
    public class DependencyFinderTests
    {
        ...
        private static string GetTestFile(string className) =>
            Path.Combine(TestContext.CurrentContext.TestDirectory, "Analysis", "Coupling", "TestClasses", $"{className}.cs");
    }
}
